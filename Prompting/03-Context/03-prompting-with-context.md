...
See how adding context to your prompt reduces variability and produces more relevant, specific output.
...
Same as before: write a user story for a login feature — but this time add context about the application and the business goal behind the feature.
