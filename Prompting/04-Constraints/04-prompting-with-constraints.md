...
See how adding constraints limits the AI's decision space and produces more predictable, scoped output.
...
Same as before: write a user story for a login feature — but this time add constraints to control what the AI should and should not include.

Think about:
- Which scenarios should be covered? Which should be excluded?
- How detailed should it be?
- What is the scope? (frontend, backend, full stack?)
