...
- [`02-Architecture/Step1`](Step1): code with an architectural violation and a failing architecture fitness test. Read [`02-Architecture/Step1/README.md`](Step1/README.md).
- [`02-Architecture/Step2`](Step2): corrected design with the architecture fitness test passing. Read [`02-Architecture/Step2/README.md`](Step2/README.md).
